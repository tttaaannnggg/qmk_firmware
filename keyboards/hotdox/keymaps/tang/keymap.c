 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|lshft |AltShf| Left | Right|                                       | RALT | left | down |  up  | right|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_GRV,            KC_1,    KC_2,    KC_3,    KC_4,   KC_5,  TG(_GAME),
        KC_TAB,            KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,  A(KC_F1),
        LT(_MDIA, KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,   KC_G,
        KC_LSFT,           KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,  A(KC_SCLN),
        KC_LCTL,        KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL,

                                                       ALT_T(KC_APP), KC_LGUI,
                                                                      KC_HOME,
                                LT(_NUM,KC_SPC), MT(MOD_LALT,KC_TAB), KC_LGUI,
        // right hand
             KC_RGHT,     KC_6,   KC_7,       KC_8,    KC_9,    KC_0,  KC_MINS,
             KC_F23,     KC_Y,   KC_U,       KC_I,    KC_O,    KC_P,  KC_BSPC,
                         KC_H,   KC_J,       KC_K,    KC_L, KC_SCLN,  KC_QUOT,
             KC_F24,     KC_N,   KC_M,    KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
[_NUM] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_0, KC_MINS,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_EQL, KC_F12,
...
[_SYM] = LAYOUT_ergodox(  // layer 2 : symmbols
        ...
        KC_Q,            KC_SLSH,       KC_LCBR, KC_LABK, KC_LBRC, KC_LPRN, KC_F21,
        KC_SLSH,       KC_LCBR, KC_LABK, KC_LBRC, KC_LPRN, KC_G,
        KC_LSFT,            KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,   KC_F22,
        ...
        // right hand
             ...
             TG(_SYM),    KC_Y,       KC_U,  KC_I,       KC_O,    KC_P, KC_F12,
